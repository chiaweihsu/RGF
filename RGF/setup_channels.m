...
% finite-difference dispersion for homogeneous space: kdx2_epsilon = 4*sin^2(kxdx/2) + 4*sin^2(kydx/2)

% sin_kxdx_over_two_sq = sin^2(kxdx/2)
sin_kxdx_over_two_sq = 0.25*kdx2_epsilon - sin(kydx/2).^2;
...
% When kdx2_epsilon is real, we choose the sign of kxdx such that:
